...
max_iters = 50000 // micro_batch_size
weight_decay = 0.0
...
def main(
    ...
    alpa.set_config(bit=bit, total_step=max_iters)
    ...
    config = LLaMAConfig.from_name("3B")
    ...
    train(fabric, model, optimizer, train_data, val_data, tokenizer_path, out_dir, do_alpa)
