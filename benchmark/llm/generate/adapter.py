...
def main(
    prompt: str = "Recommend a movie for me to watch during the weekend and explain the reason.",
    input: str = "",
    adapter_path: Path = Path("out/adapter/alpaca/llama2/alpav_1b/lit-llama-adapter-finetuned.pth"),
